...
export default function Hero() {
    ...
    return (
        ...
        >
            ...
            {/* Content */}
            <div className="relative z-10 max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-12 sm:py-20 md:py-32 text-center">
                {/* Main Title */}
                <div className="mb-6 sm:mb-8 md:mb-12 parallax-medium">
                    <h1
                        ref={titleRef}
                        className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl font-black leading-tight tracking-tight"
                ...
                >
                    <motion.p
                        ...
                        className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-400 mb-8 sm:mb-10 md:mb-16 max-w-3xl mx-auto font-light px-2"
                    >
                ...
                <motion.div
                    ...
                    className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center items-center mb-12 sm:mb-16 md:mb-32 px-2"
                >
                ...
                <motion.div
                    ...
                    className="grid grid-cols-3 gap-2 sm:gap-4 md:gap-8 max-w-4xl mx-auto px-2"
                >
                    {[
                        ...
                        <motion.div
                            ...
                            className="group"
                        >
                            <div className="relative p-3 sm:p-4 md:p-8 rounded-xl sm:rounded-2xl md:rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-primary-500/50 transition-all duration-500 overflow-hidden">
                                {/* Hover glow effect */}
                                ...
                                <p className="text-xs sm:text-sm md:text-base text-gray-500 group-hover:text-gray-400 transition-colors">{stat.label}</p>
                            </div>
                        </motion.div>
                    ))}
                </motion.div>
